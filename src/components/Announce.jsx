...
export const Announce = () => {
  return (
    <div className="flex flex-col xl:flex-row-reverse items-center justify-center gap-[2.5rem] mb-24">
      <div className="w-full xl:w-[50%] flex flex-col items-center gap-11">
        <picture>
          <source 
            srcSet={designMbl}
            media="(width < 1024px)" />
